                                    ...
                                    <?php if (!empty($devicehidn)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('devicehidn/delete/' . $device->device_hidn_id); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this device?');">
